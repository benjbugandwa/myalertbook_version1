    ...
    <section class="content">
      ...
      <div class="card card-secondary">
              <div class="card-header">
                <h3 class="card-title">Validation de l'alerte ?</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <?php
...
?>
              ...
              <form action="action_valideralerte.php" method="POST">
               
              
              
              <h3 class="card-body">Voulez-vous valider cette alerte ?</h3>
                ...
                <label>Numéro d'alerte:</label>
                                   ...
                                   <div class="card-body">
                                     ...
                                     <div class="card-body">
                                       ...
                                       <textarea class="form-control" name="descriptionfaits" id="descriptionfaits" rows="6" readonly ><?php echo $alertes['descriptionfaits'] ?></textarea>
                                     </div>
